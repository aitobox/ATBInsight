...
- **2026-09-15**: [基于 LoRA 与 HF Jobs 的异步 GRPO 训练：对象存储、代理与零 NCCL 实践](blog/posts/2026-09-15-基于-LoRA-与-HF-Jobs-的异步-GRPO-训练-对象存储-代理与零-NCCL-实践.md)
- **2026-09-14**: [脚手架内部的上下文工程：战胜长程任务中上下文溢出与目标迷失的 4 大机制](blog/posts/2026-09-14-脚手架内部的上下文工程-战胜长程任务中上下文溢出与目标迷失的4大机制.md)
...
- **2026-09-03**: [用记忆替代训练：Text-to-SQL 的列表式选择方法](blog/posts/2026-09-03-用记忆替代训练：Text-to-SQL 的列表式选择方法.md)
- **2026-09-02**: [如何从 PDF 的图表和表格中提取真正的价值](blog/posts/2026-09-02-如何从 PDF 的图表和表格中提取真正的价值.md)
- **2026-09-01**: [在 NTP 诞生之前：Daytime 与 Time 协议的前世今生](blog/posts/2026-09-01-在 NTP 诞生之前：Daytime 与 Time 协议的前世今生.md)
- **2026-08-30**: [构建一个可放入登机箱的迷你家庭实验室](blog/posts/2026-08-30-构建一个可放入登机箱的迷你家庭实验室.md)
- **2026-08-29**: [ProvenanceGuard：基于模型上下文协议（MCP）的大模型智能体源感知事实核查机制](blog/posts/2026-08-29-ProvenanceGuard：基于模型上下文协议（MCP）的大模型智能体源感知事实核查机制.md)
- **2026-08-28**: [面向持续知识图谱嵌入中候选集干扰的匹配超额超越者正则化](blog/posts/2026-08-28-面向持续知识图谱嵌入中候选集干扰的匹配超额超越者正则化.md)
