...
### Summary
Following OpenAI’s recent announcement regarding AI solving ten open problems in mathematics, this piece explores the psychological defenses ("copes") humans use to rationalize the advent of AI in intellectual fields. By examining common arguments—ranging from human-directed oversight to the social nature of mathematics—the author argues that artificial intelligence will fundamentally outpace and eventually bypass human involvement in mathematics, science, and engineering, leading to profound transformations in our society.

---

## The Coping Mechanisms

Yesterday, OpenAI [announced](https://openai.com/index/ten-advances-in-mathematics/) the solution to ten open problems in mathematics, all discovered by a yet-unreleased model. There’s only one—the coding theory one—where I know enough to say “huh, that’s important,” but according to the mathematicians I trust, this is important.
...
### 2. “We will direct the AIs, point them at problems and research areas to solve.”
The AIs will exceed humans in [taste](https://www.benkuhn.net/impact/#ii-taste) and intuition. At some point, the human pointing the way will get worse results than the human saying “here’s a proof checker, have fun” and paying for the tokens.

### 3. “We will teach the mathematics AI discovers.”
...
### 4. “We will choose how to canonize the results AI discovers.”
This is a nice cope. The AIs are explorers out in the frontiers, the humans gratefully receive their Lean proofs, and then discourse over them, choose which results are relevant, shape those results into a little brick for the great [cathedral of algebra](https://github.com/leanprover-community/mathlib4). Analogous to the above: the AIs will build the cathedral on their own. They will be better architects than us.

### 5. “We will become students of AI mathematics.”
...
### 6. “We need humans to understand the results AI discovers.”
...
### 7. “Computers are already superhuman at chess, yet we still play chess.”
...
### 8. “Mathematics will change, but mathematicians and the mathematically-inclined will still do math on their own.”
I think this ignores that mathematics is embedded in a social context. As an example: when it became clear that AI would eat software, my cope was: *"I’m perfectly happy to become an engineering manager to agents in my professional life; in my off time, I can still [write code](https://github.com/eudoxia0/) for the pleasure of it."*
